...
### Creating a tween[​](#creating-a-tween "Direct link to Creating a tween")
...
## Easing equations[​](#easing-equations "Direct link to Easing equations")
...
### Pause / Resume task[​](#pause--resume-task "Direct link to Pause / Resume task")
...
#### Stop task[​](#stop-task "Direct link to Stop task")
...
#### Play task[​](#play-task "Direct link to Play task")

```
tween.play();
```

#### Restart task[​](#restart-task "Direct link to Restart task")
...
#### Remove task[​](#remove-task "Direct link to Remove task")
...
#### Destroy task[​](#destroy-task "Direct link to Destroy task")
...
#### Get tweens[​](#get-tweens "Direct link to Get tweens")
...
#### Destroy task of a target[​](#destroy-task-of-a-target "Direct link to Destroy task of a target")
...
##### Global time-scale[​](#global-time-scale "Direct link to Global time-scale")
...
#### Set callbacks[​](#set-callbacks "Direct link to Set callbacks")
...
#### Custom ease function[​](#custom-ease-function "Direct link to Custom ease function")
...
#### Has target[​](#has-target "Direct link to Has target")

```
var hasTarget = tween.hasTarget(gameObject);
```

#### Tween value[​](#tween-value "Direct link to Tween value")
...
### Pause / Resume chain[​](#pause--resume-chain "Direct link to Pause / Resume chain")
...
### Restart chain[​](#restart-chain "Direct link to Restart chain")

```
chain.restart();
```

### Add tween task[​](#add-tween-task "Direct link to Add tween task")
...
### Remove tween task[​](#remove-tween-task "Direct link to Remove tween task")

```
chain.remove(tweenTask);
```

### Has target[​](#has-target-1 "Direct link to Has target")

```
var hasTarget = chain.hasTarget(gameObject);
```

## Flow chart[​](#flow-chart "Direct link to Flow chart")
...
## Tween data[​](#tween-data "Direct link to Tween data")
